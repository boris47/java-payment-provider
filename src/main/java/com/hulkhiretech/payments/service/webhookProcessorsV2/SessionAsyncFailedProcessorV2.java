...
@Slf4j
@Service("v2.checkout.session.async_payment_failed")
@RequiredArgsConstructor
public class SessionAsyncFailedProcessorV2 extends BaseWebhookProcessor
{
	...
	public void process(Map<String, Object> eventObj)
	{
		...
		log.info("Checkout session async payment failed: sessionId='{}', paymentStatus='{}', txnReference='{}'",
			sessionId,
